                ...
                <div class="col-lg-12">
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body" id="corps">
                                    ...
                                    <tbody>
                                        <tr style="font-size: 60%;">
                                            <td style="text-align: center;">
                                                ...
                                                @php
                                                    $titre = "";
                                                    if ($certificat->type_declaration != "DECLARATION DE DECES") {
                                                        $numcert = $certificat->numero_certificat;
                                                        $titre = $certificat->type_declaration." DE DECES";
                                                    } else {
                                                        $localiteParent = "";
                                                        $localite = "MINISTERE DE LA SANTE ET DE LA POPULATION"; 
                                                        $numcert = $certificat->code_declaration_deces;
                                                        $titre = $certificat->type_declaration;                                                       
                                                    }                                                    
                                                @endphp
                            ...
                            <br>
                            <div class="row">
                                <span class="text-center">{{$titre}} <br> Année: <strong>{{date("Y")}}</strong>; n° <strong>{{$numcert}}</strong></span>
                            </div><br>
                            <div class="row">
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <table class="corps" style="border-top: 1px solid black;">
                                        ...
                                        <tr>
                                            <td style="border: none; padding:5px 0px;text-align: " colspan="3">Est informé le : {{ date("d-m-Y", strtotime($certificat->defunt->date_naissance)). " A " .date("H", strtotime($certificat->date_heure_declaration))."H ".date("s", strtotime($certificat->date_heure_declaration))."min" }}</td>
                                        ...
                                        <tr>
                                            <td style="border: none; padding:5px 0px;text-align: " colspan="3">Situation matrimoniale:<span style="font-size: 13px;font-weight:bold;"> {{ $certificat->situationMat ? $certificat->situationMat->lib_situation_matrimoniale : $dummy}} </span></td>
                                            <td style="border: none; padding:5px 0px;text-align: " >&nbsp;</td>
                                        </tr>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <strong>Renseignements conjoint(e)</strong>
                                        <table class="corps" style="border-top: 1px solid black;">
                                            ...
                                            <tr>
                                                <td style="border: none; padding:5px 0px;text-align: " colspan="3">Nom (s) : <span style="font-size: 13px;font-weight:bold;">{{ $certificat->conjoint ? $certificat->conjoint->nom : $dummy}} </span>
                                                </td>
                                                <td style="border: none; padding:5px 0px;text-align: " >&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="border: none; padding:5px 0px;text-align: " colspan="3">Prenom (s) :<span style="font-size: 13px;font-weight:bold;"> {{ $certificat->conjoint ? $certificat->declarant->prenom : $dummy}} </span></td>
                                                <td style="border: none; padding:5px 0px;text-align: " >&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="border: none; padding:5px 0px;text-align: " colspan="3">Date de mariage : <span style="font-size: 13px;font-weight:bold;"> {{$certificat->conjoint ? date("d-m-Y", strtotime($certificat->date_mariage)) : $dummy }} </span>
                                            ...
                                            <tr>
                                                <td style="border: none; padding:5px 0px;text-align: " colspan="3">Option de mariage : <span style="font-size: 13px;font-weight:bold;"> {{ $certificat->code_regime != NULL ? $certificat->regime->lib_regime : $dummy }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="border: none; padding:5px 0px;text-align: " colspan="3">N° acte de mariage : <span style="font-size: 13px;font-weight:bold;"> {{ $certificat->conjoint ? $certificat->num_acte_mariage : $dummy }} </span>
                                                    &nbsp;&nbsp;&nbsp;&nbsp; : <span style="font-size: 13px;font-weight:bold;"> </span></td>
                                                <td style="border: none; padding:5px 0px;text-align: ">&nbsp;</td>
                                            </tr>

                                            <tr>
                                                <td style="border: none; padding:5px 0px;text-align: " colspan="3">Centre d'état civil de mariage : <span style="font-size: 13px;font-weight:bold;"> {{ $certificat->conjoint ? $certificat->cec_mariage : $dummy }} </span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<span style="font-size: 13px;font-weight:bold;">  </span></td>
                                                <td style="border: none; padding:5px 0px;text-align: ">&nbsp;</td>
                                            </tr>
                                        </table><br>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <strong>Renseignements déclarant</strong>
                                        <table class="corps" style="border-top: 1px solid black;">
                                            ...
                                            <tr>
                                                <td style="border: none; padding:5px 0px;text-align: " colspan="3">Nom (s) : <span style="font-size: 13px;font-weight:bold;">{{ $certificat->declarant ? $certificat->declarant->nom : $dummy}} </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Prénom (s) :<span style="font-size: 13px;font-weight:bold;"> {{ $certificat->declarant ? $certificat->declarant->prenom : $dummy}} </span></td>
                                                <td style="border: none; padding:5px 0px;text-align: " >&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="border: none; padding:5px 0px;text-align: " colspan="3">Date de naissance : <span style="font-size: 13px;font-weight:bold;"> {{$certificat->declarant ? date("d-m-Y", strtotime($certificat->declarant->date_naissance)) : $dummy }} </span>
                                            ...
                                            <tr>
                                                <td style="border: none; padding:5px 0px;text-align: " colspan="3">Lieu de naissance : <span style="font-size: 13px;font-weight:bold;"> {{ $certificat->declarant ? $certificat->declarant->lieu_naissance : $dummy }}</span>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; Domicile : <span style="font-size: 13px;font-weight:bold;"> {{ $certificat->declarant ? $certificat->declarant->adresse : $dummy }} </span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="border: none; padding:5px 0px;text-align: " colspan="3">Nationalite : <span style="font-size: 13px;font-weight:bold;"> {{ $certificat->declarant ? $certificat->declarant->nationalite->lib_nationalite : $dummy }} </span>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;Niveau d'instruction : <span style="font-size: 13px;font-weight:bold;"> {{ $certificat->declarant ? $certificat->declarant->niveau_instruction : $dummy }} </span></td>
                                                <td style="border: none; padding:5px 0px;text-align: ">&nbsp;</td>
                                            </tr>

                                            <tr>
                                                <td style="border: none; padding:5px 0px;text-align: " colspan="3">Profession : <span style="font-size: 13px;font-weight:bold;"> {{ $certificat->declarant ? $certificat->declarant->profession->lib_profession : $dummy }} </span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;Téléphone : <span style="font-size: 13px;font-weight:bold;"> {{ $certificat->declarant ? $certificat->declarant->telephone : $dummy }} </span></td>
                                                <td style="border: none; padding:5px 0px;text-align: ">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="border: none; padding:5px 0px;text-align: " colspan="3">Filiation : <span style="font-size: 13px;font-weight:bold;"> {{ $certificat->filiation->lib_filiation }} </span></td>
                                                <td style="border: none; padding:5px 0px;text-align: ">&nbsp;</td>
                                            </tr>
                                        </table>
                                </div>
