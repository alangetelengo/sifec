            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="{{ route('fonctionnalite.update',$fonctionnalite->code_fonctionnalite) }}" method="POST">
                            @csrf
                            @method("PUT")
                            <div class="row">
                                <div class="mb-2 col-md-6">
                                    <label class="form-label">Libéllé <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="{{ $fonctionnalite->lib_fonctionnalite }}" name="lib_fonctionnalite">

                                </div>
                                <div class="mb-2 col-md-6">
                                    <label class="form-label">Libéllé technique <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="{{ $fonctionnalite->lib_technique }}" name="lib_technique">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="mb-2 col-md-6">
                                    ...
                                    <select name="code_module" class="form-control form-control wide">
                                        <option value="">Selectionner</option>
