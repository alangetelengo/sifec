...
class RectificationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($rectificationExist != null) {
                ...
                DB::commit();
                if ($champ_id == 'date_naissance') {
                    $detailsRectification->nouvelle_valeur = date('d-m-Y', strtotime($detailsRectification->nouvelle_valeur));
                }
    ...
    public function ficheRectification($id)
    {
        ...
        if (! $rectification) {
            flash()->error('Aucune fiche de rectification trouvée pour cet acte');
        ...
        try {
            ...
            flash()->error('Erreur lors de la génération du PDF de la fiche de rectification');
