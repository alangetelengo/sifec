    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="row mt-2">
                    <div class="d-flex flex-wrap align-items-center gap-2 justify-content-between w-100 px-1">
                        ...
                        @else
                            <a href="{{ route('declarationNaissance.index') }}" class="btn btn-sm btn-info text-white mb-2">
                                <i class="fas fa-arrow-left me-1"></i> Liste des déclarations
                            </a>
                        @endif
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <input type="hidden" id="cdn-declaration" value="{{ $dn->code_declaration_naissance }}">
