...
$(function(){
    ...
    var codedeclarant = $("#codedeclarant").val();
    var typedocumentdeclarant = $("#typedocumentdeclarant").val();
    var numerodocumentdeclarant = $("#numerodocumentdeclarant").val();
    var imagedeclarant = $("#imagedeclarant").val();
    ...
    $("button.choix").on("click", function(){
        ...
        if(choix == "declarant"){
            ...
            $("button#btnScanner").html("Scanner la pièce");
            $("#pieceparentLabel").html("Joindre la pièce du "+choix)
            $("#reftypedocumentparent").val(typedocumentdeclarant);
            $("#refdocumentparent").val(numerodocumentdeclarant);
            if(imagedeclarant != ""){
                $("button#btnImporter").prop("disabled",true);
                $("button#btnScanner").prop("disabled",true);
                $("button#btnScanner").html("Pièce déjà scannée.");
    ...
    function soumission()
    {
         ...
         //déclarant
         var code_declarant = $("#code_declarant");
         ...
         var nombre_enfant = $("#nombre_enfant");
        ...
        var data =
        {
            ...
            code_declarant: code_declarant.val(),
            ...
            code_profession_declarant:profession_declarant.val(),
...
+"<tr><td style='font-weight:bold; padding:2px'></td><td style='padding:2px'>Nombre enfant <br><span style='font-weight:bold;'>"+nombre_enfant.val()+"</span></td></tr>"
...
$(document).ready(function() {
    $('#domicile_pays_enfant').trigger('change');
});
