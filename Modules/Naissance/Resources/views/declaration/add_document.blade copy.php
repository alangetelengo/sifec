                   ...
                   <div class="row">
                        ...
                        <div class="mb-2 col-sm-4">
                             <label class="radio-inline mr-3">Père
                                <input type="radio" value="père" id="pere" piece="{{ $dn->pere->document->image_document }}" name="parent" nomspere="{{ $dn->pere->nom." ".$dn->pere->prenom }}" datenais="{{ $dn->pere->date_naissance }}" lieunais="{{ $dn->pere->lieu_naissance }}" nat="{{ $dn->pere->nationalite->lib_nationalite }}" prof="{{ $dn->pere->profession->lib_profession }}" typepiece="{{ $dn->pere->document->typeDocument->lib_type_document }}" numeropiece="{{ $dn->pere->document->numero_document }}"   {{ $dn->pere->document->image_document != null ? "checked" : ""}}>
                            </label>

                            {{-- <img src="{{ $dn->pere->document->image_document }}" alt="piece" width="100px"> --}}
                        </div>
                        <div class="mb-2 col-md-4">
                            <img src='{{ asset("app/piece-jointe/".$dn->pere->document->image_document) }}' alt="alange">
...
<script>
    ...
    $(function() {
        $("#pere").on("click", function(){
            ...
            var imagepiece = $(this).attr("piece");
