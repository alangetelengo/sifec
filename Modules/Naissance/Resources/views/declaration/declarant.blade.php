<h6>Déclarant</h6>
<section class="{{ $type_declaration == "JUGEMENT D'HOMOLOGATION" ? "d-none" : "" }}">
    ...
    <div class="row">
        ...
        <div class="mb-2 col-md-4">
            ...
            <input type="text" class="form-control required"  placeholder="Nom du déclarant" id="nom_declarant" name="nom_declarant" onkeyup="verif_lettre(this);this.value=this.value.toUpperCase()">
        </div>
        <div class="mb-2 col-md-4">
    ...
    <div class="row">
       <div class="mb-2 col-md-4">
        ...
        {{-- <div class="mb-2 col-md-4">
            ...
            <a href="#" class="btn btn-info show-piece-declarant-modal"><i class="fa fa-file"></i> Joindre pièce</a>
        </div> --}}
