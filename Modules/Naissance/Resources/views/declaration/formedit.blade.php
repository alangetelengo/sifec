<form name="contactUsForm" id="contactUsForm"  method="post" action="javascript:void(0)" class="validation-wizard wizard-circle">
    ...
    <section>
        {{-- <div class="row">
            <div class="mb-2 col-sm-4" id="hide_partielle"><label class="radio-inline mr-3"><input type="radio" id="partielle" value="partielle" name="adoption" checked> Partielle</label></div>
            <div class="mb-2 col-sm-4" id="hide_pleniere"><label class="radio-inline mr-3" id="hide_pleniere"><input type="radio" id="pleniere" value="pleniere" name="adoption"> Plénière</label></div>
        </div> --}}
		 <div class="ligne">
    ...
    @include("naissance::declaration.parentedit")
</form>
