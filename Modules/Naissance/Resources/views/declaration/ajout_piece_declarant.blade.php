                    ...
                    <form id="form1" action="{{ route('declarationNaissance.store.scannerpdf') }}" method="POST" enctype="multipart/form-data" target="_blank">
                        ...
                        <div class="row">
                            <div class="mb-2 col-md-4">
                                ...
                                <select id="libtypedocument" class="form-control form-control wide" readOnly>
                                    <option value="{{ $dn->pere->document->numero_document }}"></option>
                                </select>
                            </div>
                            <div class="mb-2 col-md-4">
                                <label class="form-label">Numéro pièce d'identité</label>
                                <input type="text" name="numero_document" class="form-control form-control wide" reaonly placeholder="Numéro du document" onkeyup="this.value=this.value.toUpperCase()" value="{{ $dn->pere->document->numero_document }}">
                            </div>
