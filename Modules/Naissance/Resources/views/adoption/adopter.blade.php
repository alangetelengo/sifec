                ...
                <div class="card">
                    <div class="card-header">
                        <h4>
                            ...
                            <input type="text" class="d-none" id="codeadoptant" value="{{ $dn->declarant->code_personne }}">
                            <input type="text" class="d-none" id="typedocumentadoptant" value="{{ $dn->declarant->document->code_type_document }}">
                            <input type="text" class="d-none" id="numerodocumentadoptant" value="{{ $dn->declarant->document->numero_document }}">
                            <input type="text" name="" id="imageadoptant" class="d-none" value="{{ $dn->declarant->document->image_document }}">

                            {{-- <button type="button" class="btn btn-primary choix" data-bs-toggle="modal" parent="pere" data-bs-target="#pieceparent">
                               Joindre la pièce du jugement
                            </button> --}}
                    ...
                    <div class="card wizard-content">
                        <div class="card-body">
                           @include('naissance::adoption.formedit')
                        </div>
                    </div>
                </div>
            </div>
...
@include("naissance::adoption.js.edit")
@endsection
