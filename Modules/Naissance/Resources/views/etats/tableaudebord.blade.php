        ...
        <h4 style="text-align: center;">ACTES DE NAISSANCE</h4 style="text-align: center;">
            <table class="historique" cellspacing="0" style="width: 95%; font-size: 20px;border: 2px solid black;">
                ...
                <tbody>
                    <tr>
                        <td> CUMULEE</td>
                        <td style="text-align: center;"> <strong><span>{{ $acteproduits }}</span></strong> </td>
                        <td style="text-align: center;"> <strong><span>{{ $acteproduitsv }}</span></strong> </td>
                        <td style="text-align: center;"> <strong><span>{{ $acteproduitsn }}</span></strong> </td>
                    </tr>
                    <tr>
                        <td>L'ANNEE</td>
                        <td style="text-align: center;"> <strong><span>{{ $acteannee }}</span></strong> </td>
                        <td style="text-align: center;"> <strong><span>{{ $acteanneev }}</span></strong> </td>
                        <td style="text-align: center;"> <strong><span>{{ $acteanneen }}</span></strong> </td>
                        </tr>
                    <tr>
                        <td>DU MOIS</td>
                        <td style="text-align: center;"> <strong><span>{{ $actemois }}</span></strong> </td>
                        <td style="text-align: center;"> <strong><span>{{ $actemoisv }}</span></strong> </td>
                        <td style="text-align: center;"> <strong><span>{{ $actemoisn }}</span></strong> </td>
                    </tr>
                    <tr>
                        <td>DE LA SEMAINE</td>
                        <td style="text-align: center;"> <strong><span>{{ $actesemaine }}</span></strong> </td>
                        <td style="text-align: center;"> <strong><span>{{ $actesemainev }}</span></strong> </td>
                        <td style="text-align: center;"> <strong><span>{{ $actesemainen }}</span></strong> </td>
                        </tr>
                    <tr>
                        <td>DU JOUR</td>
                        <td style="text-align: center;"> <strong><span>{{ $actesjour }}</span></strong> </td>
                        <td style="text-align: center;"> <strong><span>{{ $actesjourv }}</span></strong> </td>
                        <td style="text-align: center;"> <strong><span>{{ $actesjourn }}</span></strong> </td>
                    </tr>
                </tbody>
            </table>
    </div>
