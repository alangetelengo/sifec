<style>
    ...
    .para{
        margin-right: 15%;text-align: justify;font-size: 80%; margin-bottom: -5px;
    }
</style>
    ...
    <table align="center" style="border-radius: 1mm; border: none;">
        <tr>
            <td style="width:100%; text-align: center;border: solid;">
                <p><strong style="font-size: 130%;margin-right: 0%;">JUGEMENT AUX FINS DE TRANSCRIPTION D'UN ACTE DE NAISSANCE </strong><br> Procureur de la République près le {{$tribunal}}</p>
            </td>
