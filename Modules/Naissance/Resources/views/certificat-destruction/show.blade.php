@extends('layout.app')
@section('titre')
Détail du certificat de destruction de l'acte
@endsection
@section('sous-titre')
Détail du certificat N° {{ $certificat->numero_certificat }} de destruction de l'acte
@endsection
@section('corps')
@php
            ...
            @if(Auth::user()->affectationActive()->code_institution == $certificat->code_institution_destinataire)
                ...
                @if($peutEnvoyer)
                    <button class="btn btn-warning btn-envoyer-centre{{ $peutEnvoyer ? '' : ' disabled' }}"
                        ...
                        data-statut-declarant="{{ $certificat->declarant->statut_personne ?? 'VIVANT' }}"
                        data-statut-pere="{{ $certificat->pere->statut_personne ?? 'VIVANT' }}"
                        data-statut-mere="{{ $certificat->mere->statut_personne ?? 'VIVANT' }}"
...
$(function(){
    ...
    $('.btn-envoyer-centre').on('click', function(){
        ...
        const statutDeclarant = $(this).data('statut-declarant') || 'VIVANT';
