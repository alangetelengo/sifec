    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h4>Requisitions aux fins de transcription de l'acte de naissance</h4>
            </div>
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    @if($requisition->top_requisition == 1)
                                                        <a class="dropdown-item" href="{{route('RequisitionTranscription.etat',$requisition->code_declaration_naissance)}}" target="_blank">Voir la réquisition</a>
                                                        @else
                                                        <form action="{{ route('RequisitionTranscription.generateRequisition',$requisition->code_declaration_naissance) }}" method="post">
                                                            @csrf
                                                            @method("PUT")
    ...
    <script>
        $(function(){
         ...
         $("button.generate").on("click", function () {
             ...
             var route = "{{ route('RequisitionTranscription.generateacte') }}";
