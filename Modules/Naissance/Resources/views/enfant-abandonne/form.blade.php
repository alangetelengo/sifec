<form name="contactUsForm" id="contactUsForm"  method="post" action="javascript:void(0)" class="validation-wizard wizard-circle" enctype="multipart/form-data">
    ...
    <div class="d-none">
        ...
        <input type="text" value="Enfant abandonné" id="personne_declaree">
    </div>
    <section>
        <div class="ligne">
           ...
           <div class="mb-2 col-md-3">
                ...
                <select id="code_lieu_survenance" class="form-control required" readonly>
                    @foreach ($lieuSurvenances as $item)
                        <option value="{{ $item->code_lieu_survenance }}" {{ $item->code_lieu_survenance == "LSURV_0001" ? "selected" : "" }}>{{ $item->lib_lieu_survenance }}</option>
                    @endforeach
                </select>
            </div>
       </div>
       ...
       <div class="row">
           ...
           <div class="mb-2 col-md-3">
               ...
               <input type="date" id="date_heure_declaration" class="form-control">
           </div>
           <div class="mb-2 col-md-3">
            ...
            <div class="mb-2 col-md-3">
                <label class="form-label">num du jugement de placement provisoir <span class="text-danger">*</span></label>
