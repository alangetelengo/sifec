...
<section>
    ...
    <div class="row">
        ...
        <div class="mb-2 col-md-3">
            <label class="form-label">Nom voie<span class="text-danger"></span></label>
            <input type="text" class="form-control" id="domicile_nomvoie_mere" placeholder="Nom voie" style="text-transform: capitalize">
        </div>
    </div>
    <div class="ligne">
        <h4>CONTACTS</h4>
...
<section>
    ...
    <div class="row">
        ...
        <div class="mb-2 col-md-12">
            ...
            <input type="text" class="form-control"  id="nom_declarant" value="CIRCONSCRIPTION D'AFFAIRE SOCIALE DE {{ Auth::user()->affectationactive()->institution->lieu->lib_localite }}">
        </div>
    ...
    <div class="row d-none">
        <div class="mb-2 col-md-4">
            ...
            <input type="date" max="<?php $jour=date("Y-m-d"); echo date('Y-m-d', strtotime($jour. ' - 18 years'));?>" min="<?php echo date('Y-m-d', strtotime($jour. ' - 100 years')); ?>"
            class="form-control"  id="date_naissance_declarant" value="{{ date('Y-m-d', strtotime($jour. ' - 18 years')) }}">
    ...
    <div class="row d-none">
       <div class="mb-2 col-md-4">
        ...
        <div class="mb-2 col-md-4">
            <label class="form-label">Numéro pièce d'identité</label>
            <input type="text" id="numero_document_declarant" name="numero_document_declarant" class="form-control" value="CASFR45200">
        </div>
