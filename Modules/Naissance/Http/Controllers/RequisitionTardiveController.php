...
class RequisitionTardiveController extends Controller
{
    ...
    public function index()
    {
        ...
        $requisitions = Declarationnaissance::where("numero_certificat","!=", "")->where('type_declaration',"CERTIFICAT DE NON INSCRIPTION")->get();
        $registre = Registre::where(["statut"=>1,"code_type_registre"=>"TPRG_0001"])->first();

        return view('naissance::requisitiontardive.index', compact('requisitions','registre'));
    }
    ...
    public function etat($id)
    {
        ...
        $html2pdf->writeHTML(view('naissance::etats.requisition', compact("requisition"))->render());

        return $html2pdf->output($requisition->code_declaration_naissance.".pdf");
    ...
    public function generateRequisition(Request $request, $id)
    {
        ...
        try{
            ...
            $transaction->code_declaration_naissance = $certificat->code_declaration_naissance;
    ...
    {
        // $regle = [
        //     "code_declaration_naissance"=>["required","string","unique:t_acte_naissance"]
        // ];
