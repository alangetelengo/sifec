...
class CertificatDestructionController extends Controller
{
    ...
    public function index()
    {
        ...
        $certificats = Declarationnaissance::where(["type_declaration"=>$typeDeclaration])->get();
    ...
    public function create()
    {
        ...
        return view('naissance::declaration.create',compact("title","type_declaration","departements", "countries","arrondissement","typedocuments","instructions","filiations","localites","professions","nationalites","situationMatrimoniales","lieuSurvenances","quartierVillages"));
