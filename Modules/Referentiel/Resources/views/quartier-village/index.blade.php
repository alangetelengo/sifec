        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4>Liste des quartiers-villages des Arrondissements/Communautés-urbaines</h4>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        <?php $i=1; ?>
                                        @foreach ($quartiersVillages as $item)
                                            <tr>
                                                <td>{{ $i++ }}</td>
                                                ...
                                                <td>
                                                        ...
                                                        <div class="modal fade bd-{{$item->code_localite}}-modal-sm" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                                            <div class="modal-dialog modal-lg">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{ route('quartierVillage.update',$item->code_localite) }}" method="POST" enctype="multipart/form-data">
                                                                        @csrf
                                                                        @method('PUT')
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="mb-2 col-md-12">
                                                                                    ...
                                                                                    <select name="code_localite_parent" class="form-control form-control wide">
                                                                                        @foreach ($arrondissementsComUrb as $arrComUrb)
                                                                                        <option value="{{ $arrComUrb->code_localite }}" {{ $item->localiteParent->code_localite_parent != null ? $item->code_localite_parent == $arrComUrb->code_localite ? "selected" : "" : "" }}>{{ $arrComUrb->lib_localite }}</option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div class="btn-group btn-group-xs">
                                                        <form action="{{ route("quartierVillage.destroy",$item->code_localite) }}" method="post">
                                                            @csrf
                                                            @method("DELETE")
        ...
        <div class="modal fade" id="modalDept" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form  action="{{ route("quartierVillage.store") }}" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                <div class="mb-2 col-md-12">
                                ...
                                <div class="mb-2 col-md-12">
                                    ...
                                    <select name="code_localite_parent" class="form-control form-control wide">
                                        ...
                                        @foreach ($arrondissementsComUrb as $arrComUrb)
                                        <option value="{{ $arrComUrb->code_localite }}">{{ $arrComUrb->lib_localite }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
