                                        ...
                                        @foreach ($departements as $item)
                                            <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <div class="modal fade bd-{{$item->code_localite}}-modal-sm" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                                            <div class="modal-dialog modal-sm">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{ route('departement.update',$item->code_localite) }}" method="POST" enctype="multipart/form-data">
                                                                        @csrf
                                                                        @method('PUT')
                                                    ...
                                                    <div class="btn-group btn-group-xs">
                                                        <form action="{{ route("departement.destroy",$item->code_localite) }}" method="post">
                                                            @csrf
                                                            @method("DELETE")
      ...
      <!-- Large modal -->
        <div class="modal fade" id="modalDept" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Information du département</h5>
