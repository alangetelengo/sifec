        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4>Liste des centres d'état civil principal</h4>
                                                                    ...
                                                                    <form action="{{ route('institution.update',$institution->code_institution) }}" method="POST" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="mb-2 col-md-12">
                                                                                    <label class="form-label">Institution parent <span class="text-danger"></span></label>
...
@section('scripts')
      ...
      <script>
        ...
        $(function() {
          ...
          //recuperer les institutions parents
