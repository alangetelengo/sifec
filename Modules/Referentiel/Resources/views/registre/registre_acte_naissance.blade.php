    ...
    <div class="col-12">
        <div class="registre-livret-toolbar-surface">
            <div class="registre-livret-toolbar-row">
                <h4 class="mb-0 flex-grow-1 min-w-0"><i class="fas fa-book-open me-2"></i>Registre de naissance</h4>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card registre-livret-doc-inner" style="min-height: 680px; border: 2px solid; text-align: left; font-size: 12px">
                            <h2>
                                {!! $registre->getTexteParapheRegistre('naissance') !!}<br><br>
                            </h2>

                            @php
                                $villeParapheNaissance = mb_strtoupper((string) ($registre->institutionUser->institution->lieu->localiteparent->lib_localite ?? ''), 'UTF-8');
                            @endphp
                            <h2><span style="margin-left: 730px;">Fait à <strong>{{ $villeParapheNaissance }}</strong>, le <strong>{{ date('d-m-Y', strtotime($registre->updated_at)) }}</strong></span></h2>
                                            ...
                                            <div class="text-end" style="min-width: 200px; flex: 1;">
                                                @php
                                                    $dateActeRegistre = $acte->signed_at
                                                        ...
                                                        ?? $acte->date_emission;
                                                    $roleActeRegistre = \App\Support\GuotSignatureAffichage::roleSignataire(
                                                        $acte,
                                                        '',
                   ...
                   <div class="col-sm-11">
                       <div class="card registre-livret-doc-inner" style="height: 670px; border: 2px solid; text-align: left; font-size: 18px">
                           ...
                           <h2>
                               ...
                               comprenant <strong>{{ \App\Sifec\Sifec::format_nombre($registre->nombre_acte_transcrit,1) }}</strong> actes  inscrits du numero <strong>1</strong> au numero <strong>{{ \App\Sifec\Sifec::format_nombre($registre->nombre_acte_transcrit,1) }}</strong>
                               inclus et <strong>{{ \App\Sifec\Sifec::format_nombre(($registre->nombre_acte_prevu - $registre->nombre_acte_transcrit),1) }}</strong> feuillets restants.<br><br>
                           <br><br><br><br><br><br>
                            </h2>
