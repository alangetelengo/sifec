@extends('layout.app')
@section('titre')
Arrondissement-Communauté Urbaine
@endsection
@section('styles')
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4>Liste des arrondissements-communautés urbaines des Communes/Districts</h4>
                            ...
                            <div class="table-responsive">
                                <table id="example" class="display" style="min-width: 845px">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Arrondissement/Communauté Urbaine</th>
                                    ...
                                    <tbody>
                                        <?php $i=1; ?>
                                        @foreach ($arrondissementsComUrb as $item)
                                            <tr>
                                                <td>{{ $i++ }}</td>
                                                ...
                                                <td>
                                                        ...
                                                        <div class="modal fade bd-{{$item->code_localite}}-modal-sm" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                                            <div class="modal-dialog modal-lg">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{ route('arrondissementCommunauteUrbaine.update',$item->code_localite) }}" method="POST" enctype="multipart/form-data">
                                                                        @csrf
                                                                        @method('PUT')
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="mb-2 col-md-12">
                                                                                    ...
                                                                                    <select name="code_localite_parent" class="form-control form-control wide">
                                                                                        @foreach ($communesDistricts as $comDist)
                                                                                            <option value="{{ $comDist->code_localite }}" {{ $item->localiteParent->code_localite_parent != null ? $item->code_localite_parent == $comDist->code_localite ? "selected" : "" : "" }}>{{ $comDist->lib_localite }}</option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div class="btn-group btn-group-xs">
                                                        <form action="{{ route("arrondissementCommunauteUrbaine.destroy",$item->code_localite) }}" method="post">
                                                            @csrf
                                                            @method("DELETE")
        ...
        <div class="modal fade" id="modalDept" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form  action="{{ route("arrondissementCommunauteUrbaine.store") }}" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                <div class="mb-2 col-md-12">
                                ...
                                <div class="mb-2 col-md-12">
                                    ...
                                    <select name="code_localite_parent" required class="form-control form-control wide">
                                        ...
                                        @foreach ($communesDistricts as $item)
