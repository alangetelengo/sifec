                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body" style="height:200px;overflow:hidden">
                                                    ...
                                                    {{-- <canvas id="pie_chart" style="display: block; height: 155px; width: 181px;" class="chartjs-render-monitor"></canvas> --}}
                                                        ...
                                                        <div id="container2" style="height: 180px"></div>
                                                </center>
                                                </div>
                                            </div>
                                        </div>
   ...
   <script>
        ...
        function getRecetteAnnuelle(periode,codeFonction){
            ...
            $.get(route,{"periode": periode,"codeFonction": codeFonction}, function (data) {
                ...
                //données des graphiques highchart
                var dataPie = "[";
                var dataBarMois = "[";
                var dataBarRecette = "[";
                var dataBar1Mois = "[";
                ...
                //graphique barChart :: Evoluation des Naissances par commune
                ...
                for(var i=0; i < libInstitutions.length ; i++){
                 ...
                 for(var j=0; j < tabMois.length ; j++){
                   ...
                   //graphique barChart :: Evolution des Naissances par mois
                for(var i=0; i < listeMoisNaissance.length ; i++){
                        var lastPosition = listeMoisNaissance.length - 1;
                        //génération de la   liste des données à charger dans le graphique
                        if(i < lastPosition){
                            dataBar1Mois= dataBar1Mois +'"'+listeMoisNaissance[i]+'",';
                            dataBar1Recette = dataBar1Recette + naissanceMois[i]+',';
                        }else{
                            dataBar1Mois= dataBar1Mois +'"'+listeMoisNaissance[i]+'"';
                            dataBar1Recette = dataBar1Recette +naissanceMois[i];
                        }
                    }
                    dataBar1Mois = dataBar1Mois +"]";
                    dataBar1Recette = dataBar1Recette +"]";

                    const datasBar1Mois =  JSON.parse(dataBar1Mois);
                    const datasBar1Recette =  JSON.parse(dataBar1Recette);
                        //graphique bar
