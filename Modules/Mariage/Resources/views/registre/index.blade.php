...
<div class="an-body">
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header"> <h4>Liste des régistres des naissances d'état civil</h4> </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('registreMariage.shows', $registre->code_registre) }}" target="_blank" title="Consulter les actes du registre" class="btn btn-warning shadow btn-xs sharp me-1"><i class="fas fa-eye"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
