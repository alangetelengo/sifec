    ...
    $(document).ready(function()
    {
        ...
        $('.validation-wizard').click(function()
        {
            ...
            if((($('#peredeclarant').is(':checked')))&&($('#statut_personne_pere').val()==="VIVANT"))
            {
                ...
                document.getElementById('domicile_rue_declarant').readOnly = true;
              ...
              //  alert($('#type_date_naissance_pere').val());
                ...
                document.getElementById('domicile_arrondissement_declarant').disabled = true;
...
<script>
    function soumission(){
        ...
        var champs = [nom_pere,
                        ...
                        domicile_rue_declarant,
                        domicile_quartier_declarant,
...
//PERE
+"<tr><td style='padding:10px' colspan='6'><hr></td></tr><tr><td style='font-weight:bold; padding:2px'>2)PERE </td><td style='padding:2px'>Nom<br><span style='font-weight:bold;'>"+ nom_pere.val() +" </span></td><td style='padding:2px'>Prenom<br><span style='font-weight:bold;'> "+prenom_pere.val()+"</span></td><td style='padding:2px'>Date naissance<br><span style='font-weight:bold;'>"+dateFrench(date_naissance_pere.val())+"</span></td><td style='padding:2px'>Adresse<br><span style='font-weight:bold;'>"+domicile_numero_pere.val()+" "+domicile_rue_declarant.val()+" "+domicile_arrondissement_declarant.text()+"</span></td><td style='padding:2px'>Telephone<br><span style='font-weight:bold;'>"+telephone_pere.val()+"</span></td></tr>"
