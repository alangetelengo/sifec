 ...
 <page orientation="portrait" backimg="{{ asset("tpl/armoirie_congo.png") }}" backcolor="#FEFEFE" backimgx="center" backimgy="50%" backimgw="100%" backtop="0"  backbottom="30mm" style="font-size: 12pt">
   ...
   <table align="center" style="border-radius: 1mm; border: none;">
    ...
    <div style="margin-left: 4px;border-radius: 2mm;">
       ...
       <div style="position: absolute; left: 8px; top: 310px; width: 780px; height: 1000px; padding: 0px; overflow: hidden; text-align: left; font-weight: normal; font-size:16px;">
           <table align="left" style="border-radius: 1mm; border: none;">
            <tr style="margin-right: 10px;">
                <td>
                    ...
                    Vu la requête aux fins de dispense de publication, de tout délai et de lieu en vue de célébration <br>
                    d’un mariage formulée en date du 31 octobre 2022 par <strong>Monsieur {{ $requisition->epoux->nomcomplet() }}</strong> ; <br>
                    ...
                    {{ $requisition->epoux->nationalite->lib_nationalite }}, domicilié au {{  $requisition->epoux->adresse }} et <strong>Madame {{ $requisition->epouse->nomcomplet() }}</strong>, de nationalité {{ $requisition->epouse->nationalite->lib_nationalite }}, domiciliée <br>
                    au {{  $requisition->epouse->adresse }}. <br><br>
                    ...
                    Que le requérant sollicite une dispense de lieu et de délai de publication de bans afin que leur <br>
                    mariage soit célébré au <strong>{{ $requisition->adresse_celebration_mariage }}</strong>, à une date plus <br>
                    proche que prévue. <br><br>

                    Attendu qu’il résulte que la célébration de ce mariage par l'officier d'état-civil, hors le centre <br>
                    d’état-civil, est fixée à une date plus proche, au point où il en serait nécessaire de déroger aux prescriptions légales imposant le lieu de célébration, la publication de bans et de délais <br>
                    conformément aux dispositions des articles 143, 144, 150 et 151 du code de la famille. <br>
