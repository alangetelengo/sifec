<style>
 ...
 <page orientation="portrait" backimg="{{ asset("tpl/armoirie_congo.png") }}" backcolor="#FEFEFE" backimgx="center" backimgy="50%" backimgw="100%" backtop="0"  backbottom="30mm" footer="date;time;page" style="font-size: 12pt">
   ...
   <div style="margin-left: 4px;border-radius: 2mm;">
       <div style="position: absolute; left: 8px; top: 310px; width: 700px; height: 1000px; padding: 0px; overflow: hidden; text-align: left; font-weight: normal; font-size:20px;">
           <table align="left" style="border-radius: 1mm; border: none;">
            <tr style="margin-right: 10px;">
                <td>
                    ...
                    Vu la requête aux fins de dispense de publication et de lieu en vue de célébration d’un mariage<br>
                    ...
                    Que le requérant sollicite une dispense de lieu de célébration afin que leur mariage soit célébré <br>
                    au <strong>{{ $requisition->adresse_celebration_mariage }}</strong>. <br><br>

                    Attendu qu’il résulte que la célébration de ce mariage par l'officier d'état-civil, hors le centre <br>
                    d’état-civil,est fixée à la date du {{strftime("%d %B %Y", strtotime(date($requisition->date_prevue_mariage)))}}, au point où il en serait nécessaire de déroger <br>
                    aux prescriptions légales imposant le lieu de célébration conformément aux dispositions des <br>
                    articles 143, 144, 150 et 151 du code de la famille. <br>
