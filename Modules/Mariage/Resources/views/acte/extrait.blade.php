            ...
            <div class="card-header">
                ...
                <div class="row">
                    <div id="dupcreer" class="d-flex gap-2 justify-content-end">
                        @if($acte)
                            <button type="button" class="btn btn-primary" id="btn-imprimer-extrait" title="Imprimer l'extrait d'acte de mariage">
                                <i class="fas fa-print me-1"></i>Imprimer l'extrait
                            </button>
                        @endif
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <div class="alert alert-danger" role="alert">
                                ...
                                <p>L'extrait d'acte de mariage demandé n'a pas été trouvé dans le système.</p>
                                <hr>
    ...
    $(function() {
        @if($acte)
            ...
            if (cdm && typeof pdfjsLib !== 'undefined') {
                var route = "{{ route('acteMariage.displayExtrait', ':id') }}".replace(':id', cdm);
                loadPdfWithJs(route);
            } else if (cdm) {
        ...
        @endif
        $("#btn-imprimer-extrait").on("click", function() {
