            ...
            <div class="card-header">
                ...
                <div class="row">
                    <div id="dupcreer" class="d-flex gap-2 justify-content-end">
                        @if($acte && ($acte->retirer ?? 0) == 0)
                            <button type="button" class="btn btn-primary" id="btn-imprimer-acte" title="Imprimer l'acte de mariage">
                                <i class="fas fa-print me-1"></i>Imprimer l'acte
                            </button>
                        @elseif($acte && ($acte->retirer ?? 0) == 1)
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <div class="alert alert-danger" role="alert">
                                ...
                                <p>L'acte de mariage demandé n'a pas été trouvé dans le système.</p>
                                <hr>
    ...
    $(function() {
        @if($acte)
            ...
            if (cdm && typeof pdfjsLib !== 'undefined') {
                var route = "{{ route('acteMariage.display', ':id') }}".replace(':id', cdm);
                loadPdfWithJs(route);
            } else if (cdm) {
