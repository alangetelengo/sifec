    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="row">
                    <div id="dupcreer">
                        <a href="{{ route("acteMariage.index") }}"><button type="button" class="btn btn-info m-t-2 float-end text-white" >Liste des actes</button></a>
                    </div>
                </div>
            </div>
            <div class="col-12">
 ...
 <script>
    $(function() {
        @if($acte)
            ...
            if(cdm) {
                // kendo.alert("ok");
                var route = "{{ route('acteMariage.display', ':id') }}";
