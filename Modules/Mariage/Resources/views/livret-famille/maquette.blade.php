                    ...
                    <div class="col-6">
                        ...
                        <table style="margin-left: 2%; text-align: left;"> <thead> <tr> <th></th> <th></th> <th></th> </tr> </thead>
                            <tbody> <tr> <td>Le <strong>{{ date("d/m/Y", strtotime($am->declaration->date_prevue_mariage)) }}</strong></td> </tr> <tr>
                                ...
                                <td>Né le <strong> {{ date("d", strtotime($am->declaration->epoux->date_naissance)) ." ".\App\Sifec\Sifec::mois(date("m", strtotime($am->declaration->epoux->date_naissance))) ." ". date("Y", strtotime($am->declaration->epoux->date_naissance)) }}</strong> A <strong>{{ $am->declaration->epoux->lieu_naissance }}</strong></td> </tr> <tr> </tr> <tr>
                                ...
                                <td>Né le <strong> {{ date("d", strtotime($am->declaration->epouse->date_naissance)) ." ".\App\Sifec\Sifec::mois(date("m", strtotime($am->declaration->epouse->date_naissance))) ." ". date("Y", strtotime($am->declaration->epouse->date_naissance)) }}</strong> A <strong>{{ $am->declaration->epouse->lieu_naissance }}</strong></td> </tr> <tr> </tr> <tr>
