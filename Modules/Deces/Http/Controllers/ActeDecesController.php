...
class ActeDecesController extends Controller
{
    ...
    public function displayActe($id)
    {
        try {
            ...
            if ($acte == null) {
                ...
                flash()->error('Vous ne pouvez pas générer un acte de décès. Acte introuvable.');
    ...
    public function displayExtrait($id)
    {
        ...
        if ($acte == null) {
            flash()->error("Vous ne pouvez pas générer un extrait d'acte de décès");
    ...
    public function decesApprouver($id)
    {
        ...
        if ($acte == null) {
            flash()->error('Vous ne pouvez pas signé cet acte de décès');
        ...
        if (Gate::allows('module.acteDeces.signature')) {
            ...
            try {
                ...
                flash()->success('Acte signé avec succès');
        ...
        flash()->error("Vous n'avez pas la permission de signer cet acte de décès");
    ...
    public function annulerActe(Request $request)
    {
        ...
        $acte = ActeDeces::where('code_declaration_deces', $code)->first();
        if (! $acte) {
            return response()->json([
                'code' => '404',
                'message' => 'Aucun acte trouvé pour ce code.',
