        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-info d-flex align-items-center mb-4" role="alert">
                    ...
                    <div>
                        <strong>Information :</strong> Cette action enregistrera le retrait de l'acte de décès.
                ...
                <div class="row">
                        ...
                        <input type="hidden" id="code_acte_deces">
                    </div>
                            <div class="form-text">Numéro unique de l'acte de décès</div>
                        </div>
...
<script>
    ...
    function openRetraitModal() {
        @if($acte)
            ...
            $('#code_acte').val('{{ $acte->code_acte_deces }}');
            $('#code_acte_deces').val('{{ $acte->code_acte_deces }}');
    ...
    function handleRetraitActe() {
        ...
        const data = {
            codeactedeces: $('#code_acte_deces').val(),
