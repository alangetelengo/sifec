           ...
           $('.validation-wizard').click(function()
            {
                ...
                if((($('#code_situation_matrimoniale_defunt').val()!="SMAT_0001")))
                {
                  ...
                  // {{--  $('#domicile_conjoint').val("");
                   ...
                   document.getElementById('domicile_ville_conjoint').disabled = false;
                ...
                //    document.getElementById('domicile_typevoie_conjoint').disabl = true;
                ...
                //    document.getElementById('domicile_ville_conjoint').readOnly = true;
                //    document.getElementById('domicile_ville_conjoint').disabled = true;
                ...
                if ($('#peredeclarant').is(':checked')) {
                    sexe_declarant = sexe_declarant.val("M");
                       ...
                       document.getElementById('domicile_district_declarant').readOnly = true;
