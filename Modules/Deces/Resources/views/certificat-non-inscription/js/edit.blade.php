        ...
        $.ajax({
                ...
                success: function(response){
                    ...
                    $("tr.tr").on("click", function (){
                        ...
                        $("#domicile_rue_defunt").val(rue);
                        $("#domicile_quartier_defunt").val(quartier);
                        if($(this).data('arrondissement')===null)
                        {
                          $("#domicile_district_defunt").val("choisissez");
                        }else{
                            $("#domicile_district_defunt").val(arrondissement);
                        }
            ...
            $.ajax({
                    ...
                    success: function(response){
                        ...
                        $("tr.tr").on("click", function (){
                            ...
                            $("#code_pays_conjoint").val(indicatif);
                            ...
                            $("#domicile_rue_conjoint").val(rue);
                            $("#domicile_quartier_conjoint").val(quartier);
                            if($(this).data('arrondissement')===null)
                            {
                              $("#domicile_district_conjoint").val("choisissez");
                            }else{
                                $("#domicile_district_conjoint").val(arrondissement);
                            }
            ...
            $.ajax({
                    ...
                    success: function(response){
                        ...
                        $("tr.tr").on("click", function (){
                            ...
                            if($(this).data('arrondissement')===null)
                            {
                              $("#domicile_district_pere").val("choisissez");
                            }else{
                                $("#domicile_district_pere").val(arrondissement);
                            }
...
if(($('#code_situation_matrimoniale_defunt').val()==="SMAT_0001"))
{
    ...
    conjoint="";
                ...
                Swal.fire({
                    width:2500,
                    position: 'top',
                    title: "Enrégistrer la déclaration de décès ?",
                    icon: 'question',
    ...
    +"<tr><td style='padding:5px;' colspan=11><hr style='border:none;'></td></tr></table><bR><br>Assurez-vous, puis confirmez !</div> ",
                ...
                }).then(function (e)
                {
                    ...
                    if (e.value === true)
                    {
                        ...
                        var domicile_pays_defunt = $("#domicile_pays_defunt option:selected").text();
                        var domicile_numero_defunt = $("#domicile_numero_defunt");
                        var domicile_rue_defunt = $("#domicile_rue_defunt");
                        var domicile_quartier_defunt = $("#domicile_quartier_defunt");
                        var domicile_district_defunt = $("#domicile_district_defunt");
                        ...
                        var domicile_rue_mere = $("#domicile_rue_mere");
                        ...
                        var domicile_rue_conjoint = $("#domicile_rue_conjoint");
                        var domicile_quartier_conjoint = $("#domicile_quartier_conjoint");
                        var domicile_district_conjoint = $("#domicile_district_conjoint");
                        ...
                        var domicile_rue_declarant = $("#domicile_rue_declarant");
                        ...
                        // $.ajax({
                        //     type: 'POST',
                        //     url: "{{route('declarationDeces.update',':id')}}",
                        var data = {
                            ...
                            domicile_rue_defunt: domicile_rue_defunt.val(),
                            domicile_quartier_defunt:domicile_quartier_defunt.val(),
                            domicile_district_defunt: domicile_district_defunt.val(),
                            // domicile_district_defunt: domicile_district_defunt.val(),
                            ...
                            num_acte_mariage: num_acte_mariage.val(),
                                ...
                                domicile_rue_pere: domicile_rue_pere.val(),
                                ...
                                domicile_rue_mere: domicile_rue_mere.val(),
                            ...
                            domicile_rue_declarant: domicile_rue_declarant.val(),
                        ...
                        var code = "{{$declaration->code_declaration_deces}}";
                        var route = "{{route('declarationDeces.update',':id')}}";
        ...
        $(document).ready(function()
        {
           ///alert("o");
            ...
            $('#clear_defunt').click(function()
            {
                ...
                $('#domicile_rue_defunt').val("");
                document.getElementById('domicile_rue_defunt').readOnly = false;
                ...
                var domicile_district_defunt = $("#domicile_district_defunt");
                    domicile_district_defunt.val("");
                    $("#domicile_district_defunt option:selected").text();
                document.getElementById('domicile_district_defunt').disabled = false;
            ...
            $('#clear_pere').click(function()
            {
                ...
                $('#domicile_rue_pere').val("");
                document.getElementById('domicile_rue_pere').readOnly = false;
                ...
                var domicile_district_pere = $("#domicile_district_pere");
                    ...
                    $("#domicile_district_pere option:selected").text();
                document.getElementById('domicile_district_pere').disabled = false;
                ...
                var code_pays_pere = $("#code_pays_pere");
                    code_pays_pere.val("");
                    $("#code_pays_pere option:selected").text();
                document.getElementById('code_pays_pere').disabled = false;
...

            {
                ...
                $('#domicile_rue_mere').val("");
                document.getElementById('domicile_rue_mere').readOnly = false;
                ...
                var code_pays_mere = $("#code_pays_mere");
                    code_pays_mere.val("");
                    $("#code_pays_mere option:selected").text();
                document.getElementById('code_pays_mere').disabled = false;
            ...
            $('#clear_declarant').click(function()
            {
                ...
                $('#domicile_rue_declarant').val("");
                document.getElementById('domicile_rue_declarant').readOnly = false;
                ...
                var domicile_district_declarant = $("#domicile_district_declarant");
                    ...
                    $("#domicile_district_declarant option:selected").text();
                ...
                var code_pays_declarant = $("#code_pays_declarant");
                    ...
                    $("#code_pays_declarant option:selected").text();
            ...
            $('#clear_conjoint').click(function()
            {
               ...
               // {{--  $('#domicile_conjoint').val("");
                ...
                $('#domicile_rue_conjoint').val("");
                document.getElementById('domicile_rue_conjoint').readOnly = false;
                ...
                var domicile_district_conjoint = $("#domicile_district_conjoint");
                    domicile_district_conjoint.val("");
                    $("#domicile_district_conjoint option:selected").text();
                document.getElementById('domicile_district_conjoint').disabled = false;
                ...
                var code_pays_conjoint = $("#code_pays_conjoint");
                    code_pays_conjoint.val("");
                    $("#code_pays_conjoint option:selected").text();
           ...
           $('.validation-wizard').click(function()
            {
                ...
                if((($('#code_situation_matrimoniale_defunt').val()!="SMAT_0001")))
                {
                  ...
                  // {{--  $('#domicile_conjoint').val("");
                   ...
                   document.getElementById('domicile_rue_conjoint').readOnly = true;
                   document.getElementById('domicile_quartier_conjoint').readOnly = true;
                   document.getElementById('domicile_district_conjoint').disabled = true;
                   document.getElementById('code_pays_conjoint').disabled = true;
            ...
            $('input:radio[name="autredeclarant"]').change(function(){
                ...
                if(declarant != "" || declarant != null)
                {
                    ...
                    if(declarant == "pere")
                    {
                       ...
                       domicile_rue_declarant.val(domicile_rue_pere.val());
                    ...
                    else if(declarant == "mere")
                    {
                        ...
                        domicile_rue_declarant.val(domicile_rue_mere.val());
                    ...
                    else if(declarant == "conjoint")
                    {
                       ...
                       domicile_rue_declarant.val(domicile_rue_conjoint.val());
                       domicile_quartier_declarant.val(domicile_quartier_conjoint.val());
                       domicile_district_declarant.val(domicile_district_conjoint.val());
                       $("#domicile_district_declarant option:selected").text();
