    ...
    <script>
        ...
        $(".tab-wizard").steps({
            ...
            onFinished: function (event, currentIndex) {
                Swal.fire("Déclaration Enrégistrée !", "Dossier est en cours de traiatement, consectetur adipiscing elit. Sed lorem erat eleifend ex semper, lobortis purus sed.");
...
if(($('#code_situation_matrimoniale_defunt').val()==="SMAT_0001"))
{
    ...
    conjoint="";
                ...
                Swal.fire({
                    width:2500,
                    position: 'top',
                    title: "Enrégistrer la déclaration tardive ?",
                    icon: 'question',
                           ...
                           // data: {_token: token},
                            success: function(response )
                            {
                                ...
                                if (response.success==true)
                                {
                                    ...
                                    var url= "{{ route('certificatNonInscriptionDeces.index') }}";
                                    setTimeout(() => {
                                        window.open(url);
                                    }, 2000);
                                } else {
