            ...
            <div class="col-12">
                <div class="card wizard-content">
                    <div class="card-body">
                        ...
                        <h4>Créer un certificat de non inscription</h4>
                        ...
                        <form  name="contactUsForm" id="contactUsForm" class="validation-wizard wizard-circle" method="post" action="javascript:void(0)">
                            ...
                            <h6>Défunt</h6>
                            <div class="d-none">
                                <input type="text" value="CERTIFICAT DE NON INSCRIPTION" id="type_declaration">
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control required  @error('date_defunt') is-invalid @enderror " placeholder="" id="date_deces"  name="date_deces"  max="{{ \Carbon\Carbon::now()->format('Y-m-d'); }}" value="{{ $datedeces }}">
                                                @error("date_deces")
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="lieu_survenance_code" id="lieu_survenance_code" class="form-select form-control required">
                                                ...
                                                @foreach ($lieusurvenances as $lieusurvenance)
                                                    @if($lieusurvenance->code_lieu_survenance != "LSURV_0004"&& $lieusurvenance->code_lieu_survenance != "LSURV_0005" && $lieusurvenance->code_lieu_survenance != "LSURV_0006")
