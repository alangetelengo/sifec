            ...
            <div class="col-12">
                <div class="card wizard-content">
                    <div class="card-body">
                        ...
                        <h4>Créer une fiche de déclaration tardive</h4>
                        ...
                        <form  name="contactUsForm" id="contactUsForm" class="validation-wizard wizard-circle" method="post" action="javascript:void(0)">
                           ...
                           {{--  <button type="button" class="btn btn-success mb-2" data-bs-toggle="modal" data-bs-target=".search_mere-modal-lg">Faire une recherche</button>  --}}
                            <section>
                                ...
                                <div class="row">
                                    <div class="ligne">
                                        <h4>INFORMATIONS SUR LE DECES</h4>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="mb-2 col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="domicile_numero_defunt" placeholder="numero parcelle">
                                </div>

                                <div class="mb-2 col-md-3">
                                    <label class="form-label">Rue <span class="text-danger"></span></label>
                                    <input type="text" class="form-control" id="domicile_rue_defunt" placeholder="rue ou avenue">

                                </div>
                                <div class="mb-2 col-md-3">
                                    <label class="form-label">Quartier<span class="text-danger"></span></label>
                                    <input type="text" class="form-control" id="domicile_quartier_defunt" placeholder="quartier">

                                </div>
                                <div class="mb-2 col-md-3">
                                    <label class="form-label">Arron.<span class="text-danger"></span></label>
                                    <select name="domicile_arrondissement_defunt" id="domicile_arrondissement_defunt" class="form-control ">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-2 col-md-3">
                                        <label class="form-label">Adr. N°<span class="text-danger"></span></label>
                                        <input type="text" class="form-control" id="domicile_numero_conjoint" placeholder="numero parcelle">

                                    </div>
                                    <div class="mb-2 col-md-3">
                                        <label class="form-label">Rue <span class="text-danger"></span></label>
                                        <input type="text" class="form-control" id="domicile_rue_conjoint" placeholder="rue ou avenue">

                                    </div>
                                    <div class="mb-2 col-md-3">
                                        <label class="form-label">Quartier<span class="text-danger"></span></label>
                                        <input type="text" class="form-control" id="domicile_quartier_conjoint" placeholder="quartier">

                                    </div>
                                    <div class="mb-2 col-md-3">
                                        <label class="form-label">Arron.<span class="text-danger"></span></label>
                                        <select name="domicile_arrondissement_conjoint" id="domicile_arrondissement_conjoint" class="form-control ">
                                            <option value=" ">Choisissez</option>
                                            @forelse ($arrondissement as $code)
                                                <option value="{{ $code->code_arrondissement }}">{{ $code->lib_arrondissement }}</option>
                                            @empty
