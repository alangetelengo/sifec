        ...
        $.ajax({
                ...
                success: function(response){
                    ...
                    $("tr.tr").on("click", function (){
                        ...
                        {
                          $("#domicile_arrondissement_defunt").val("choisissez");
                        }else{
                            $("#domicile_arrondissement_defunt").val(arrondissement);
                        }
...
if(($('#code_situation_matrimoniale_defunt').val()==="SMAT_0001"))
{
    ...
    conjoint="";
                ...
                Swal.fire({
                    width:2500,
                    position: 'top',
                    title: "Enrégistrer le certificat de non inscription de décès ?",
                    icon: 'question',
    ...
    +"<tr><td style='padding:5px;' colspan=11><hr style='border:none;'></td></tr></table><bR><br>Assurez-vous, puis confirmez !</div> ",
                ...
                }).then(function (e)
                {
                    ...
                    if (e.value === true)
                    {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "{{route('certificatNonInscriptionDeces.store')}}",
                            data: {
    ...
    <script>
        $(document).ready(function()
        {
            ...
            $('#clear_defunt').click(function()
            {
                ...
                var domicile_arrondissement_defunt = $("#domicile_arrondissement_defunt");
                    domicile_arrondissement_defunt.val("");
                    $("#domicile_arrondissement_defunt option:selected").text();
                document.getElementById('domicile_arrondissement_defunt').disabled = false;
