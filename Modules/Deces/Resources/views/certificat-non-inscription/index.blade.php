    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h4>Liste des certificat de non inscription de décès</h4>
            </div>
            <div class="card-body">
                <form id="formdata" class="validation-wizard wizard-circle">
                    @csrf
                    <div class="mb-2 col-md-4">
                        <label class="form-label">Date de décès du défunt <span class="text-danger">*</span></label>
                        <input type="date" name="date_deces" max="<?php echo date('Y-m-d'); ?>" class="form-control" id="date_deces" required>
                    </div>
                    <div class="mb-2">
                        <div id="texte"></div>
    ...
    $(function() {
        ...
        $('#date_deces').on('change', function() {
            ...
            if (jours_deces <= 1) {
                ...
                lien = '<div class="alert alert-warning"><strong>⚠️ Action requise :</strong> Vous devez créer un <b>certificat de non inscription de décès</b>.<br>Une réquisition est requise conformément à l\'article 60 du code de la famille.</div>';
                type = 'certificat';
            }
            else if (jours_deces > 30) {
                ...
                lien = '<div class="alert alert-warning"><strong>⚠️ Action requise :</strong> Vous devez créer un <b>certificat de non inscription de décès</b>.<br>Une réquisition ou un jugement est requis conformément à l\'article 60 du code de la famille.</div>';
                type = 'certificat';
            }
            $('#texte').html(message);
            $('.validate').html(lien);
        ...
        $('#formdata').on('submit', function(e) {
            ...
            if (jours_deces <= 1) {
                ...
                // Pour les cas > 1 jour, on redirige toujours vers le certificat de non inscription
                url = "{{ route('certificatNonInscriptionDeces.create') }}";
            }
