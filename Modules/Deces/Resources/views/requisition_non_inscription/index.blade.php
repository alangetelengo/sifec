                                    ...
                                    <tr width="100%">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <a class="dropdown-item" href="{{route('RequisitionNonInscriptionDeces.etat',$requisition->code_declaration_deces)}}" target="_blank">Voir la réquisition</a>
                                                {{-- <a class="dropdown-item show-acte-modal" href="{{$requisition->code_declaration_deces}}">Générer l'acte</a> --}}
                                                @else
                                                <form action="{{ route('RequisitionNonInscriptionDeces.generateRequisition',$requisition->code_declaration_deces) }}" method="post">
                                                    @csrf
                                                    @method("PUT")
