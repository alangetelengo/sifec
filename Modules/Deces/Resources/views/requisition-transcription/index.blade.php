    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h4>Requisitions aux fins de transcription d'acte de décès</h4>
            </div>
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    @if($requisition->top_requisition == 1)
                                                        <a class="dropdown-item" href="{{route('RequisitionTranscriptionDeces.etat',$requisition->code_declaration_deces)}}" target="_blank">Voir la réquisition</a>
                                                    @else
                                                        <form action="{{ route('RequisitionTranscriptionDeces.generateRequisition',$requisition->code_declaration_deces) }}" method="post">
                                                            @csrf
                                                            @method("PUT")
                                                            <button type="submit" class="dropdown-item">Générer la réquisition</button>
                                                        </form>
                                                        <a href="{{ route('declarationDeces.etat',$requisition->code_declaration_deces) }}" target="_blank" class="dropdown-item">Voir document</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
    ...
    <script>
        $(function(){
         ...
         $("button.generate").on("click", function () {
             ...
             $.post(route, {code_acte:code_acte,code_declaration_deces:code_declaration_deces}, function(reponse) {
