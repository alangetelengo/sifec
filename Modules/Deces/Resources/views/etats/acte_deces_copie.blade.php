    ...
    <table cellspacing="0" style="width: 100%; font-size: 10pt;">
        <tr>
            <td style="width:35%; text-align: center;">
                <p>
                    <span><strong>{{$communeDistrict}}</strong></span> <br>
    ...
    <table align="center" style="border-radius: 1mm; border: none;">
        <tr style="">
            <td style="width:100%; text-align: center;">
                <p><strong style="font-size: 150%;">COPIE INTEGRALE ACTE DE DECES</strong><br> Année: <strong>{{date("Y", strtotime($acte->declaration->date_heure_declaration))}}</strong> Acte n°:<strong>{{ $acte->code_acte_deces }}</strong></p>
            </td>
