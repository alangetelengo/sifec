    ...
    <table align="center" style="border-radius: 1mm; border: none;">
        <tr>
            <td style="width:100%; text-align: center; border:solid;margin:10%;">
                <p><strong style="font-size: 130%;margin-right: 0%;">REQUISITION AUX FINS DE DECLARATION TARDIVE DE DECES </strong><br> Procureur de la République près le {{$requisition->institutionUser->institution->pompeFunebre->institutionParent->lib_institution}}</p>
            </td>
        </tr>
    </table>
