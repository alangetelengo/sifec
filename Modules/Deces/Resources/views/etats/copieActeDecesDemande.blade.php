{{-- 
    Vue copie acte de décès pour demande de document
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: left;">
                       <p>Fait à {{ ucfirst(strtolower($localisationActe)) }}, le {{ $demande->date_signature ? $demande->date_signature->format('d/m/Y') : now()->format('d/m/Y') }}</p>
