                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: center; font-size:15px">
                            Fait à {{ ucfirst(strtolower($ddc->institutionUser->institution->lieu->localiteParent->lib_localite)) }}  , le {{utf8_encode(strftime("%d %B %Y", strtotime( $ddc->created_at)))}}<br> Chef de service
                         </td>
                      </tr>
                </tbody>
            </table>
