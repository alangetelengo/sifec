            ...
            <div class="col-12">
                <div class="card wizard-content">
                    <div class="card-body">
                        ...
                        <h4 class="">Créer un certificat de constatation de décès</h4>
                        ...
                        <form  name="contactUsForm" id="contactUsForm" class="validation-wizard wizard-circle" method="post" action="javascript:void(0)">
                            ...
                            <h6>Défunt</h6>
                            <div class="d-none">
                                <input type="text" value="CERTIFICAT DE CONSTATATION DE DECES" id="type_declaration">
                            </div>
                            ...
                            <section>
                                ...
                                <div class="row">
                                   ...
                                   <div class="mb-2 col-md-3">
                                    ...
                                    <div class="mb-2 col-md-3">
                                        <div class="form-group">
                                            <label class="form-label">Lieu de décés (Arrondissement) <span class="text-danger">*</span></label>
                                            <select name="lieu_deces" id="lieu_deces" class="form-select form-control required">
                                                 <option disabled selected>Choisissez</option>
