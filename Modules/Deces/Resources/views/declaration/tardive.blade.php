            ...
            <div class="col-12">
                <div class="card wizard-content">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Créer une déclaration tardive de décès</h4>
                        ...
                        <form  name="contactUsForm" id="contactUsForm" class="validation-wizard wizard-circle" method="post" action="javascript:void(0)">
                            ...
                            <h6>Défunt</h6>
                            <div class="d-none">
                                <input type="text" value="DECLARATION TARDIVE" id="type_declaration">
                            </div>
