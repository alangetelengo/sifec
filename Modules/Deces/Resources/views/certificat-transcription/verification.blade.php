                    ...
                    <div class="card wizard-content">
                        <div class="card-body">
                            <form action="#" class="validation-wizard wizard-circle">
                                <div>
                                    <h4 id="texte"></h4>
                                    <h4 class="text-primary" id="noninscript"><a href="{{route('certificatNonInscriptionDeces.create')}}"><span style="color:red">Cliquer sur ce lien : Le délais de déclaration est supérieur à 30 jours, faite un certificat de non inscription de décès</span></a></h4>
                                </div>
 ...
 <script>
    ...
    function age() {
        ...
        if (n_jours>15) {
            $("#noninscript").show();
            $("#inscript").hide();
            $('#texte').html('Nombre de jours sans déclaré: '+parseInt(n_jours)+' jours');
            return false;
        }else{
            $("#inscript").show();
            $("#noninscript").hide();
