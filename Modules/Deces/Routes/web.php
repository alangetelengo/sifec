...
use Modules\Deces\Http\Controllers\LivretDecesController;
...
Route::middleware("auth")->prefix('declarationDeces')->group(function() {
    ...
    Route::get('verification/datedeces', [DecesController::class,'verification'])->name("declarationDeces.verification");
...
Route::prefix('centreHygiene')->group(function() {
...
Route::middleware('auth')->prefix('acteDeces')->group(function() {
    ...
    Route::get("{id}/send-otp", [ActeDecesController::class,'sendOtp'])->name("acteDeces.send.otp");
...
Route::middleware('auth')->prefix('certificatNonInscriptionDeces')->group(function() {
    ...
    Route::post('create', [CertificatNonInscriptionController::class,'create'])->name("certificatNonInscriptionDeces.create");
